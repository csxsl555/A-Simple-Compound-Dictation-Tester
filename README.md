...
ℹ️ **无痛一键上手**：应用已默认集成内置 DeepSeek 免费体验 API Key！初次访问或本地运行时，您无需填写任何 API 密钥即可直接点击“一键生成/AI 智能主题听写”。系统也完美保留了右上角设置（⚙️）中的自定义接口，让您随时更换为属于您自己的 DeepSeek / Gemini 私人 API Key。
